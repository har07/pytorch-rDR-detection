...
parser = argparse.ArgumentParser(description='Preprocess Kaggle APTOS data set.')
parser.add_argument("--data_dir", help="Directory where Kaggle APTOS resides.",
                    default="data/aptos")

args = parser.parse_args()
data_dir = str(args.data_dir)

labels = join(data_dir, 'train.csv')
...
with open(labels, 'r') as f:
    ...
    for i, row in enumerate(reader):
        ...
        im_path = join(data_dir, "train_images/{}".format(filename))
