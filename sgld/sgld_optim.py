...
class SGLD(Optimizer):
    """
    Translated from Li Chunyuan's implementation (matlab), with modification to support burn in steps
    https://github.com/ChunyuanLI/pSGLD/blob/master/pSGLD_DNN/algorithms/SGLD.m
    """
    ...
    def step(self, lr=None):
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                d_p = torch.tensor(lr)*d_p + torch.sqrt(2*torch.tensor(lr)) * \
